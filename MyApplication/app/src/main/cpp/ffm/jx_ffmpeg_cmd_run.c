...
Java_com_xqd_myapplication_util_FFmpegBridge_jxCMDRun(JNIEnv *env, jclass type,
...
Java_com_xqd_myapplication_util_FFmpegBridge__initJXFFmpeg(JNIEnv *env, jclass type,
                                                                           jboolean debug,
                                                                           jstring logUrl_) {
    JNI_DEBUG = debug;
